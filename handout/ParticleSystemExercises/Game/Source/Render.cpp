...
bool Render::DrawParticle(SDL_Texture* texture, int x, int y, const SDL_Rect* section, const SDL_Rect* rectSize, float speed, double angle, int pivotX, int pivotY) const
{
	uint scale = app->win->GetScale();
